...
#define TX_VIDEO_PIPELINE_ALL_LUT_MASK                              0x0000003F /*[5:0], 0 : bypass incoming raw data(default), 1: ednable the video pipeline function
                                                                                * Bit-0 : 1D_LUT for CCT
                                                                                * Bit-2 : 3D_LUT
																				* Bit-3 : 1D_LUT for EnGamma & DICOM
																				* Bit-4 : 1D_LUT for De-Gamma
																				* Bit-5 : 1D_LUT Extra
																				*/
#define TX_VIDEO_PIPELINE_1D_LUT_CCT_BYPASS_MASK					0x00000001 /* Bit-0 : 0: bypass incoming raw data(default), 1: ednable the video pipeline function */
...
#define TX_VIDEO_PIPELINE_1D_LUT_ENGAMMA_DICOM_BYPASS_MASK          0x00000008 /* Bit-3 : 0: bypass incoming raw data(default), 1: ednable the video pipeline function */
...
#define TX_VIDEO_PIPELINE_1D_LUT_EXTRA_BYPASS_MASK					0x00000020 /* Bit-5 : 0: bypass incoming raw data(default), 1: ednable the video pipeline function */

#define TX_VIDEO_PIPELINE_1D_LUT_CCT_BYPASS							0x00000000 /* Bit-0, bypass incoming raw data */ 
#define TX_VIDEO_PIPELINE_1D_LUT_CCT_ENABLE							0x00000001 /* Bit-0, ednable the video pipeline function */
...
#define TX_VIDEO_PIPELINE_1D_LUT_ENGAMMA_DICOM_BYPASS               0x00000000 /* Bit-3, bypass incoming raw data */  
#define TX_VIDEO_PIPELINE_1D_LUT_ENGAMMA_DICOM_ENABLE               0x00000008 /* Bit-3, ednable the video pipeline function */
...
#define TX_VIDEO_PIPELINE_1D_LUT_EXTRA_BYPASS                       0x00000000 /* Bit-5, bypass incoming raw data */  
#define TX_VIDEO_PIPELINE_1D_LUT_EXTRA_ENABLE                       0x00000020 /* Bit-5, ednable the video pipeline function */
...
#define MAX_3D_LUT_ENTRIES                                          4913       /* 17x17x17 */
#define FLASH_LUT_INDEX_MAX                                         815        /* 15 + 160 x 5 */
#else /* ! _FPGA_SUPPORT_3D_LUT_ */
